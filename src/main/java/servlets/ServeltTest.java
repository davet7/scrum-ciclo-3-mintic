...
public class ServeltTest extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Peliculas l1 = new Peliculas(1, "titulo1", "genero1", "autor1", 1, true);
        Peliculas l2 = new Peliculas(2, "titulo2", "genero2", "autor2", 2, false);
        ...
        Gson gson = new Gson();
        String result = gson.toJson(Peliculas);
        response.setContentType("text/html;charset=UTF-8");
